...
def executar_comando(comando):
    ...
    print(f"\n> Executando: {comando}")
    try:
        # Força os scripts filhos a usarem UTF-8
        env = os.environ.copy()
        env['PYTHONUTF8'] = "1"
        ...
        while True:
            ...
            if output:
                ...
                # "Limpa" a saída para ser compatível com o console do Windows/n8n
                # antes de imprimir, evitando o erro 'charmap'.
                safe_output = output.strip().encode(sys.stdout.encoding, errors='replace').decode(sys.stdout.encoding)
                print(safe_output)
